namespace MidSpace.ShipScan.SeModCore.Messages
{
    ...
    /// <summary>
    /// Sound helper to either playing sounds directly on the client, or have the Server queue up sounds to play to the specific Client.
    /// Example: MessageClientSound.PlaySound("HudClick");
